...
// 1) arraydeki istifadecilerin id lerini key olaraq objectlerin ozlerini (itemlerin) lerini value olaraq mapa daxil
//  edin function daxilinde try catch istifade ederek yazin taski
//   const newMap=()=>{
//     try {
//         let map = new Map()
//         users.forEach((user)=>{
//             if(!user.id){
//                 throw new Error("Istifadecinin IDsi movcud deyil");
//                  }
...
//   let userMap = newMap();
//   if(userMap){
//     console.log("yaradilmis Map", userMap);

// console.log(`ID olan istifadeci`, userMap.get(67) );

//   }
// 2) yuxaridaki functiona bir id parametri qebul etsin ve hemin parametre gore hemin userin hansi role malik oldugunu
// map vasitesile tapib logda yazdirin
...
//     })
//     let user = idMap.get(id)
//     if (user) {
//         console.log(`ID-si ${id} olan istifadecinin rolu:  ${user.role} `);
//     }
//     else {
//         console.log(`ID-si ${id} olan istifadeci tapilmadi `);
//     }
// }
// userRole(15)
// userRole(90)
...
//     let changeObj = Object.fromEntries(map);
//     console.log("Map-in Obyekt formasi", changeObj);

//     let changeArray = Array.from(map);

//     console.log("Map-in Array formasi", changeArray);
// }
// result()
